        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
                ...
                ?>
              <li class="nav-item">
                <a href="index.php?halaman=kelas_x&id=<?=$kelas['id_kelas']=1;?>" class="nav-link ">
                  <i class="far fa-circle nav-icon"></i>
                  <p>X MIPA</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="index.php?halaman=kelas_xi&id=<?=$kelas['id_kelas']=2;?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>XI MIPA</p>
                </a>
              </li>
  ...
  <div class="content-wrapper">
    ...
    <div class="content">
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            <!-- ===Put Here Your Code Starts=== -->
            <?php 
                if(isset($_GET['halaman'])) {
                    if($_GET['halaman']=='siswa') {
                        include "siswa.php";
                    }else if($_GET['halaman']=='tambah_siswa') {
                        include "tambah_siswa.php";
                    }else if($_GET['halaman']=='ubah_siswa') {
                        include "ubah_siswa.php";
                    }else if($_GET['halaman']=='hapus_siswa') {
                        include "hapus_siswa.php";
                    }else if($_GET['halaman']=='kelas_x') {
                        include "kelas_x.php";
